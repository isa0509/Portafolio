...
<nav class="navbar bg-body-tertiary fixed-top" data-bs-theme="dark">
    ...
    <form action="calculo_figuras.php" method="post">
        ...
        <input type="text" name="lado1" required><br>
...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($figura === "cuadrado") {
            ...
            $base = floatval($_POST["lado1"]);
            $altura = floatval($_POST["lado2"]);
            $area = 0.5 * $base * $altura;
            echo "Área del triángulo: " . $area;
        } elseif ($figura === "circulo") {
            $radio = floatval($_POST["lado1"]);
