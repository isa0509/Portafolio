...
<body>
    ...
    <div class="main">
        <center>
            <img src="https://www.clinicaciplex.com/wp-content/uploads/2020/07/blog_IMC.jpg" width="290px"
                height="290px" />
            <h1>CALCULA EL IMC</h1>
            <form action="" method="post">
                <input type="number" name="peso" id="peso" placeholder="Peso (kg)">
                <br><br>
                <input type="number" name="estatura" id="estatura" placeholder="estatura (cm)">
                <br><br>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($imc < 18.5) {
            echo "<p>Usted está bajo peso.</p>";
        } elseif ($imc > 18.5 &&  $imc < 29.9 ) {
            echo "<p>Usted tiene un peso saludable.</p>";
        } elseif ($imc > 29.9) {
            echo "<p>Usted tiene sobrepeso.</p>";
        } else {
            echo "<p>Usted tiene obesidad.</p>";
        }
    }
    ?>
        </center>
