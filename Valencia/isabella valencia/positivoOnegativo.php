...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!is_numeric($numero)) {
        $mensaje = "<div class='mensaje'>Por favor, introduce un número válido.</div>";
    } else {
        if ($numero > 0) {
            echo "<div class='positivo'>El número es positivo.</div>";
        } else if ($numero < 0) {
            echo "<div class='negativo'>El número es negativo.</div>";
        } else {
            echo "<div class='cero'>Has introducido el número CERO.</div>";
        }
    }
}
?>
