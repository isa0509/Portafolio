...
<nav class="navbar bg-body-tertiary fixed-top" data-bs-theme="dark">
    ...
    <div class="main">
        <center>
            <h1>Calculadora de Ventas Semanal</h1>

            <form action="" method="post">
                <label for="dia1">Día 1:</label>
                <input type="number" name="dia1" required><br>

                <label for="dia2">Día 2:</label>
                <input type="number" name="dia2" required><br>

                <label for="dia3">Día 3:</label>
                <input type="number" name="dia3" required><br>

                <label for="dia4">Día 4:</label>
                <input type="number" name="dia4" required><br>

                <label for="dia5">Día 5:</label>
                <input type="number" name="dia5" required><br>

                <label for="dia6">Día 6:</label>
                <input type="number" name="dia6" required><br>

                <label for="dia7">Día 7:</label>
                <input type="number" name="dia7" required><br>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $totalVentas = array_sum($cantidades);
