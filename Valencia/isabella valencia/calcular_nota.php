...
<body>
    ...
    <div class="main">
        <center>
            <h1>Calculadora de Notas - Colegio Comfandi</h1>
            <br><br>
            <form action="" method="post">
                ...
                <br><br>
                <input type="number" name="nota4" id="nota4" placeholder="nota 4">
                <br><br>
                <button>Calcular nota final</button>
            </form>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        echo "Nota Definitiva: " . $nota_definitiva;
    }
    ?>
        </center>
    </div>
